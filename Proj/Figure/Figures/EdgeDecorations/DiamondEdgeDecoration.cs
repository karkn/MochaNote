...
namespace Mkamo.Figure.Figures.EdgeDecorations {
    [Externalizable]
    public class DiamondEdgeDecoration: AbstractPathEdgeDecoration {
        // ========================================
        // constructor
        // ========================================
        public DiamondEdgeDecoration() {
        }
        ...
        protected override GraphicsPathDescription CreatePath() {
            ...
            ret.AddLine(new Point(8, 4), new Point(16, 0));
            ret.AddLine(new Point(16, 0), new Point(8, -4));
