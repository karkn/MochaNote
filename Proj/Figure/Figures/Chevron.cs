...
namespace Mkamo.Figure.Figures {
    public class Chevron: AbstractPathBoundingNode {
        // ========================================
        // constructor
        // ========================================
        public Chevron() {
        ...
        protected override GraphicsPathDescription CreatePath(Rectangle bounds) {
            ...
            var triangleRight = Math.Min(bounds.Left + bounds.Height / 2, bounds.Left + bounds.Width / 2);
            ...
            var pt6 = new Point(triangleRight, bounds.Top + bounds.Height / 2);
