...
namespace Mkamo.Memopad.Internal.Controllers {
    internal class UmlInterfaceRealizationController:
        AbstractModelController<UmlInterfaceRealization, LineEdge>, IConnectionController {
        ...
        // method
        // ========================================
        protected override LineEdge CreateFigure(UmlInterfaceRealization model) {
        ...
        protected override void RefreshEditor(RefreshContext context, LineEdge figure, UmlInterfaceRealization model) {
        }
        ...
        public bool CanConnectTarget(object connected) {
            return connected is UmlInterface;
        }

        public void ConnectSource(object connected) {
            Model.Client = connected as UmlClassifier;
        }

        public void ConnectTarget(object connected) {
            Model.Supplier = connected as UmlInterface;
        }
