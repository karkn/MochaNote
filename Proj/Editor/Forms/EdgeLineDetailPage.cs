...
namespace Mkamo.Editor.Forms {
    public partial class EdgeLineDetailPage: LineConfigurator, IDetailSettingsPage {
        // ========================================
        // field
        // ========================================
        ...
        // constructor
        // ========================================
        public EdgeLineDetailPage(IEnumerable<IEditor> targets) {
            InitializeComponent();
            _targets = targets;
        }
